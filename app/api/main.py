...
def test_get():
	print(api_func.get_address_geom('ул Большая переяславская 50 Москва'))
	print(api_func.get_street_geom(api_func.get_address_geom('Москва Большая переяславская 50'), 'Москва Большая переяславская'))
